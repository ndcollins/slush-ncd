...
module.exports = function(gulp) {
    ...
    gulp.task('view', function(done) {
        ...
        if (modules.length === 0) {
          throw new Error('view must be created in a module, but no modules exist. Create a module using "slush angular-gulp:module <module-Name>".');
        }
        ...
        inquirer.prompt([{
            ...
            gulp.src(__dirname + '/../templates/view/view.html')
                ...
                .pipe(rename(answers.fileName + '-view.html'))
